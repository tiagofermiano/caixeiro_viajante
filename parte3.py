...
class GeneticAlgorithmTSP:
    def __init__(self, num_cities=10, population_size=50, mutation_rate=0.1, generations=100):
...
genetic_tsp = GeneticAlgorithmTSP(num_cities, population_size, mutation_rate, generations)
genetic_tsp.run()